...
function fromOneDimArrayOfUint8ToUint32s() {
  ...
  var r1 = type.fromPar(i1, j => j*2);
  var r2 = type.fromPar(i1, 1, j => j*2);
...
function fromOneDimArrayOfUint32ToUint8s() {
  ...
  var i1 = intype.build(i => i);
  var r1 = type.fromPar(i1, j => j*200);
  var r2 = type.fromPar(i1, 1, j => j*200);
...
function fromTwoDimArrayOfUint8ToUint32s() {
  ...
  var r1 = type.fromPar(i1, 2, x => x*2);
  var r2 = type.fromPar(i1, 1, a => rowtype.fromPar(a, 1, x => x*2));
  var r3 = type.fromPar(i1, 1,
    a => rowtype.fromPar(a, 1, (x, j, c, out) => Handle.set(out, x*2)));
  var r4 = type.fromPar(i1, 1, (a, j, c, out) => { out[0] = a[0]*2;
                                                  out[1] = a[1]*2;
                                                  out[2] = a[2]*2;
                                                  out[3] = a[3]*2; });
...
function fromOneDimArrayOfArrayOfUint8ToUint32s() {
  ...
  var r1 = type.fromPar(i1, x => combine(x[0], x[1], x[2], x[3]));
  var r2 = type.fromPar(i1, 1,
...
function fromOneDimArrayOfUint32ToArrayOfUint8s() {
  ...
  var r1 = type.fromPar(i1, x => divide(x));
  var r2 = type.fromPar(i1, 1, (x, i, c, out) => {
...
function fromOneDimArrayOfStructsToStructs() {
  ...
  var r1 = type.fromPar(i1, doubleG);
  var r2 = type.fromPar(i1, 1, doubleG);
  var r3 = type.fromPar(i1, 1, (g, j, c, out) => { out.f = g.f * 2; });
...
function fromTwoDimArrayOfStructsToStructs() {
  ...
  var r1 = type.fromPar(i1, 2, doubleG);
  var r2 = type.fromPar(i1, 1, (m) => rowtype.fromPar(m, 1, doubleG));
  var r3 = type.fromPar(i1, 1,
...
function fromOneDimArrayOfStructsToArrayOfStructs() {
  ...
  var r1 = Box.fromPar(i1, (g) => Line.build((y) => tenG(g.f, y)));
  var r2 = Box.fromPar(i1, (g) => Line.fromPar(i1, (y) => tenG(g.f, y.f)));
  var r3 = Box.fromPar(i1,
